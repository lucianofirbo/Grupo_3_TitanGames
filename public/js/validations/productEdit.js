...
window.addEventListener("load", function () {
    ...
    switch (true) {
      ...
      case !regLongName.test($productName.value):
        $productNameErrors.innerHTML =
          "Debes ingresar un nombre de más de 5 carácteres";
        $productName.style.backgroundColor = "rgba(255, 126, 126, 0.466)";
        break;
      default:
    ...
    switch (true) {
      ...
      case !regLongDescription.test($description.value):
        $descriptionErrors.innerHTML =
          "Debe ingresar una descripción de al menos 20 caracteres";
        $description.style.backgroundColor = "rgba(255, 126, 126, 0.466)";
        break;
      default:
  ...
  $file1.addEventListener("change", function fileValidation() {
  ...
  $file2.addEventListener("change", function fileValidation() {
  ...
  $file3.addEventListener("change", function fileValidation() {
  ...
  $file4.addEventListener("change", function fileValidation() {
  ...
  $file5.addEventListener("change", function fileValidation() {
  ...
  $form.addEventListener("submit", function (event) {
    ...
    for (let index = 0; index < elementosForm.length - 1; index++) {
      if (
        ...
        elementosForm[index].name !== "genero" &&
        elementosForm[index].name !== "subGenero" &&
        ...
        elementosForm[index].style.backgroundColor =
          "rgba(255, 126, 126, 0.466)";
